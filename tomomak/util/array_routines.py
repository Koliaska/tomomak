...
def normalize_broadcasted(data, index, mesh, data_type):
    """ Normalize broadcasted data after broadcast_object() in order to conserve  initial density.

    Args:
        data (ndarray): data, generated by broadcast_object() function.
        index (int or tuple of ints):  In the new array input array will be represented using this index or indexes.
        mesh (tomomak.main_structures.Mesh): mesh to work with.
        data_type (str): type of the data. Available options: 'solution', 'detector_geometry'.
    ...
    for i in other_axes:
        ...
        total_vol = mesh.axes[i].total_volume
