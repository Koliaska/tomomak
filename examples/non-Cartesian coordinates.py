...
from tomomak.detectors import detectors2d, signal, detectors3d
...
# Let's only half of the toroidal grid, so we can see the crossection:
...
# A few words about the detectors. They work similar to objects.
